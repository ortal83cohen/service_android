 ...
 */
public class StringRequest<R> extends RequestWithBodySupport<String,R>{
     ...
     */
    public StringRequest(int method, String url, R body, Response.Listener<String> listener,
