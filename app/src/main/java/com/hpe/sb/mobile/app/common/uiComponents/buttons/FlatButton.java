...
/**
 * Created by cohenort on 23/06/2016.
 */
public class FlatButton extends Button {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            defBorderWidth = context.getResources().getDimensionPixelOffset(
            ...
            button_presentation = extension_button_presentation(mAttr.getInt(
                    R.styleable.FlatButton_pb_presentation, BUTTON_BOTTOM_PAD));
    ...
    protected LayerDrawable createDisabledDrawable() {
        ...
        layer0.setColor(getColorXML(
                R.color.grey_disabled, R.styleable.FlatButton_pb_colorDisabled));
        return normal;
    }
    ...
    protected Drawable createPressedDrawable() {
        ...
        drawablePressed.setColor(getColorXML(
                R.color.blue_pressed, R.styleable.FlatButton_pb_colorPressed));
