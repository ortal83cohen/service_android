...
public class RequestResolveUserItem extends UserItem {
    ...
    protected Comment solutionComment;

    public RequestResolveUserItem() {
    }

    public RequestResolveUserItem(String id, RequestType requestType, String title, String description, String solution, String requestedForName,
            long creationTime, Comment solutionComment) {
        this.id = id;
    ...
    protected RequestResolveUserItem(Parcel in) {
        id = in.readString();
        title = in.readString();
    ...
    public static final Creator<RequestResolveUserItem> CREATOR
            = new Creator<RequestResolveUserItem>() {
        @Override
        public RequestResolveUserItem createFromParcel(Parcel in) {
            return new RequestResolveUserItem(in);
        }

        @Override
        public RequestResolveUserItem[] newArray(int size) {
            return new RequestResolveUserItem[size];
        }
    };
    ...
    public boolean equals(Object o) {
        ...
        RequestResolveUserItem that = (RequestResolveUserItem) o;
